...
namespace System
{
    public static partial class PlatformDetection
    {
        ...
        public static bool IsWindows10Version20348OrGreater => false;
        ...
        private static int GetWindowsProductType() => 0;
        internal static bool IsWindowsVersionOrLater(int major, int minor, int build = -1) => false;
        private static string GetWindowsInstallationType() => string.Empty;
