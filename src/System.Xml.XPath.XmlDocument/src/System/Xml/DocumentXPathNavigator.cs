...
namespace System.Xml
{
    internal sealed class DocumentXPathNavigator : XPathNavigator
    {
        ...
        private static bool PathHasDuplicateNamespace(XmlElement top, XmlElement bottom, string localName)
        {
            string namespaceUri = XmlConst.ReservedNsXmlNs;
            while (bottom != null
                   && bottom != top)
        ...
        private static XmlNode ParentNode(XmlNode node)
        {
            XmlNode parent = node.ParentNode;
        ...
        private static XmlNode FirstChild(XmlNode node)
        {
        ...
        private static XmlNode NextSibling(XmlNode node)
        {
        ...
        private static XmlNode PreviousSibling(XmlNode node)
        {
        ...
        private static XmlNode PreviousText(XmlNode node)
        {
        ...
        private static XmlNode TextStart(XmlNode node)
        {
            XmlNode start;
        ...
        private static XmlNode TextEnd(XmlNode node)
        {
            XmlNode end;
