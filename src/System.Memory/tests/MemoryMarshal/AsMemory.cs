...
namespace System.MemoryTests
{
    public static partial class MemoryMarshalTests
    {
        ...
        public static void AsMemory_RoundtripsInt(ReadOnlyMemory<int> readOnlyMemory) => AsMemory_Roundtrips_Core(readOnlyMemory, true);

        [Theory]
        [MemberData(nameof(ReadOnlyMemoryObjectInstances))]
        public static void AsMemory_RoundtripsObj(ReadOnlyMemory<object> readOnlyMemory) => AsMemory_Roundtrips_Core(readOnlyMemory, false);

        [Theory]
        [MemberData(nameof(ReadOnlyMemoryCharInstances))]
        public static void AsMemory_RoundtripsChar(ReadOnlyMemory<char> readOnlyMemory)
        {
