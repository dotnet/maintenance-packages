...
namespace System.SpanTests
{
    public static partial class ReadOnlySpanTests
    {
        ...
        [InlineData("Hello", SoftHyphen + "Hello" + SoftHyphen, StringComparison.CurrentCultureIgnoreCase, true)]
        ...
        [InlineData("Hello", SoftHyphen + "Hello" + SoftHyphen, StringComparison.InvariantCulture, true)]
        ...
        [InlineData("Hello", SoftHyphen + "Hello" + SoftHyphen, StringComparison.InvariantCultureIgnoreCase, true)]
        ...
        public static void EqualsWithStringsAndComparisonType(string s1, string s2, StringComparison comparisonType, bool expected)
        {
