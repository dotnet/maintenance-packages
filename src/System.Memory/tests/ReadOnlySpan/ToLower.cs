    ...
    public static partial class ReadOnlySpanTests
    {
        ...
        public static void ToLowerNullCulture()
        {
            ...
            try
            {
                ...
                Assert.Fail("Expected exception: " + typeof(ArgumentNullException).GetType());
            }
            ...
            {
                Assert.Fail("Wrong exception thrown: Expected " + typeof(ArgumentNullException).GetType() + ": Actual: " + wrongException.GetType());
            }
        }
        ...
        [InlineData("hello", "hello")]
        [InlineData("", "")]
        public static void ToLowerSpecificStrings(string s, string expected)
        {
        ...
        public static IEnumerable<object[]> ToLower_Culture_TestData()
        {
