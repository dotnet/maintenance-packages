...
| Microsoft.CSharp                        | Limited          | Contains an implementation that is unused in all the currently supported frameworks. | Do not reference the package. All the features are part of the shared framework of all the currently supported frameworks. |
...
| System.Data.SqlClient                   | Limited          | [Supported until .NET 8 goes EOL.](https://techcommunity.microsoft.com/blog/sqlserver/announcement-system-data-sqlclient-package-is-now-deprecated/4227205) | <ul><li>.NET 4.6.2+ and .NET 6.0+: Either Update to the latest version of the package or migrate to Microsoft.Data.SqlClient.</li><li>.NET 9+: System.Data.SqlClient is unsupported. Migrate to Microsoft.Data.SqlClient.</ul> |
