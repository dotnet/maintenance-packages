...
2. Ensure that the source project doesn't have the property `<IsPackable>false</IsPackable>` set. This will ensure that the package for this library will be produced as part of the build.
